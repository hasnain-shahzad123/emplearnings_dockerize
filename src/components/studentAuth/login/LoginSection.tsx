...
import { sendPasswordResetEmail } from "firebase/auth"; // Add this import
...
const LoginFormContent = () => {
  ...
  const handleLoginWithGoogle = async (
    ...
    //TODO: change this to student login with google
    e.preventDefault();
    const serviceResponse = await loginUserWithGoogleService("student");
  ...
  const handleLoginWithFacebook = async (
    ...
    //TODO: change this to student login with facebook
    // e.preventDefault();
