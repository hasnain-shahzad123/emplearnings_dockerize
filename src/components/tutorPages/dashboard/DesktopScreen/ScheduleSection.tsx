    ...
    <>
      <div className="flex flex-col items-center">
        <div className="bg-white grid grid-cols-12 px-7 py-5 rounded-xl gap-7 shadow-xl">
          {
          <div className=" col-span-6 nxl:col-span-3 flex flex-col font-semibold xl:text-lg items-center">
            <Image
              src={total_students.src}
              alt="Total Students"
              width={50}
              height={50}
              className="h-8 w-8"
            />
            <h1 className="text-sm mt-2">Total Students</h1>
           {
          ...
          <div className="col-span-6 nxl:col-span-3 flex flex-col font-semibold xl:text-lg items-center">
            <Image
              src={active_students.src}
              alt="Active Students"
              width={50}
              height={50}
              className="h-8 w-8"
            />
            <h1 className="text-sm mt-2">Active Students</h1>
            <h2 className="text-2xl mt-2 font-semibold text-[#4A148C]">
              {activeStudents}
            </h2>
          </div>
          ...
          <div className="col-span-6 nxl:col-span-3 flex flex-col font-semibold items-center">
            <Image
              src={pending_lessons.src}
              alt="Pending Lessons"
              width={50}
              height={50}
              className="h-8 w-8"
            />
            <h1 className="text-sm mt-2 text-center">Pending Lessons</h1>
