...
export default async function logoutStudentFromDashboard(): Promise<
...
> {
    try {
        ...
        console.error("Error while logging out student from dashboard", error);
        return {
            type: "error",
            message: "Error while logging out student from dashboard",
        };
    }
}